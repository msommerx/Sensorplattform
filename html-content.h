...
<h3 style='min-height:100px;'><a href='/' style='background:none;width:0;'><img src='/luftdaten_logo.svg' style='float:left;margin-right:20px'/></a>{t} Sensorplattform {id}<br/><small>MAC: {mac}<br/>Firmware {fw}</small></h3>\
";
